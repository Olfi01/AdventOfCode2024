...
{
    public class Day04ServiceTests
    {
        [Theory]
        ...
        {
            Assert.Equal(meetsCriteria, Day04Service.MeetsPart1Criteria(number));
        }
        ...
        {
            Assert.Equal(meetsCriteria, Day04Service.MeetsPart2Criteria(number));
        }
    }
}