...
{
    public class Day04ServiceTests : DayServiceTestsBase
    {
        private Day04Service service;

        public Day04ServiceTests()
        {
            service = new Day04Service(inputServiceMock.Object);
        }
