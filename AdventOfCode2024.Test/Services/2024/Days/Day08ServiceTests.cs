...
{
    public class Day08ServiceTests : DayServiceTestsBase
    {
        private readonly Day08Service service;

        public Day08ServiceTests()
        {
            service = new Day08Service(inputServiceMock.Object);
        }
