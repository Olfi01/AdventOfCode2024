...
{
    public class Day03ServiceTests : DayServiceTestsBase
    {
        private readonly Day03Service service;

        public Day03ServiceTests()
        {
            service = new Day03Service(inputServiceMock.Object);
        }
